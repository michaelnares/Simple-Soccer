...
public:
	...
	void CalculateClosestOpposingPlayer();
	PlayerBase* ClosestOpposingPlayer() 
	{
		CalculateClosestOpposingPlayer();
		return m_pClosestOpponent 
	};
