...
private:
  ...
  //boolean to set whether player is controlled by the computer or not

  bool m_bControlledByComputer;
public:
  ...
  void UpdateTargetsOfDefaultStateingPlayers()const;
  ...
  {
	  return m_bControlledByComputer;
  }

  void SetControlledByComputer(bool b) 
  {
	  m_bControlledByComputer = b;
  }
